      ...
      <div className="w-full max-w-4xl rounded-2xl bg-[#06283D] p-6 md:p-10 shadow-lg">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <form className="flex flex-col gap-4">
            ...
            <TextInput type="text" placeholder="Name" required className="rounded-md bg-[#DFF6FF] p-2" />
            <TextInput type="email" placeholder="Email" required className="rounded-md bg-[#DFF6FF] p-2" />
            <TextInput type="text" placeholder="Subject" required className="rounded-md bg-[#DFF6FF] p-2" />
            <Textarea placeholder="Message" rows={4} required className="rounded-md bg-[#DFF6FF] p-2" />

            <Button type="submit" className="w-full rounded-md bg-[#1363DF] text-white text-lg">
              Send
            </Button>
          </form>
